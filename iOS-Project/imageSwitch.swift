...
//  iOS-Project
//
//  Created by SABai on 30/07/2016.
...
class imageSwitch: UIScrollView, UIScrollViewDelegate{
    ...
    func timerAction(){
        ...
        if(self.isFirstRun){
            ...
            //创建imageView
                self.centerView?.image = UIImage(named: "johny_srouji")
